...
DATABASES = {
    'default': {
        ...
        'NAME': 'sandhiya',       # lowercase to match actual DB name
        'USER': 'root',
        'PASSWORD': 'Monishgv@28',   # your MySQL root password
        'HOST': 'localhost',
        'PORT': '3306',
        'OPTIONS': {
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'monishgv28@gmail.com'
EMAIL_HOST_PASSWORD = 'uidg mvco yyqf unhs'
